...
<nav class="navbar <?php echo trim(implode(' ', $navbar_classes)) ?>" role="navigation">
  ...
  <div class="container<?php echo (bootstrap3_is_fluid_navbar() ? '-fluid' : '-fluid') ?>">
    ...
    <div class="navbar-header">
      ...
      <?php
        ...
        tpl_link(
            wl(),
            '<img src="'.$logo.'" alt="'.$title.'" class="img-circle pull-left'.(($tagline) ? ' dw-logo-tagline' : '').'" id="dw__logo" '.$logo_size.' style="margin-top:-10px" /> <span id="dw__title" '.($tagline ? 'style="margin-top:-5px"': '').'>'. $title . $tagline .'</span>',
